...
# hyperparameter_tuning(agent_type="ddpg", episodes=episodes, lr_list=lr_list, num_layers_list=num_layers_list, nbs_units_list=nbs_units_list, batch_size_list=batch_size_list, discretized=False)
...
pg_train_losses = pg_agent.train(deep_hedging_env, episodes=episodes)
...
print(" ----------------- ")
deltas_DH, hedging_err_DH = Utils_general.delta_hedge_res(test_set, r_borrow, r_lend, params_vect[1], T, option_type=option_type, position_type=position_type, strike=strike, V_0=V_0, 
...
print(" ----------------- ")
deltas_DH_leland, hedging_err_DH_leland = Utils_general.delta_hedge_res(test_set, r_borrow, r_lend, params_vect[1], T, option_type=option_type, position_type=position_type, strike=strike, V_0=V_0,
